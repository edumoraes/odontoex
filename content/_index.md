...
technical_responsible_cro = ""
registered_specialty = ""
clinic_address = "7 unidades em Manaus: Boulevard, Cachoeirinha, Cidade Nova T3, Sumaúma, Nova Cidade, Raiz e Planalto."
official_contact = "(92) 98107-2056"
instagram_url = "https://www.instagram.com/odontoexcellence_manaus"
instagram_label = "@odontoexcellence_manaus"
clinic_units = [
  "AV. Boulevard - Nossa Sra. das Graças, em frente ao Hospital Santa Júlia",
  "Cachoeirinha - Av. Carvalho Leal, próximo à panificadora Cíntia",
  "Cidade Nova T3 - Av. Guaranás, 15, próximo ao terminal T3",
  "Sumaúma - Próximo ao shopping Sumaúma",
  "Nova Cidade - Em frente ao DB",
  "Raiz - Av. Tefé, próximo ao mercado C.O",
  "Planalto - Em frente ao PAC do Alvorada",
]
clinic_hours = [
  "Segunda a sexta: das 09:00 às 20:00",
  "Sábado: das 09:00 às 13:00",
  "Sumaúma, Cidade Nova T3 e Cachoeirinha: sábado das 09:00 às 17:00",
  "Domingo: fechado",
]
+++
...
Opções de implantes dentários para substituir dentes perdidos, conforme avaliação da saúde bucal, estrutura óssea e planejamento profissional.

### Próteses fixas

Alternativas para quem busca mais estabilidade na reabilitação do sorriso, com indicação definida após avaliação e planejamento individual.
...
Indicação, tratamento, valores, formas de pagamento e condições comerciais dependem de avaliação individual, planejamento odontológico e política vigente da unidade.
